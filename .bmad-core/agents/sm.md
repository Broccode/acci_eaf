...
`.bmad-core/templates/story-tmpl.md` `story-draft-checklist`:
...
startup:
  ...
  - 'CRITICAL RULE: You are ONLY allowed to create/modify story files - NEVER implement! If asked to
    implement, tell user they MUST switch to Dev Agent'
commands:
