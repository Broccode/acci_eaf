...
class TenantManagementEndpointTest {
        ...
        @Test
        fun `should create tenant successfully via endpoint`() = runTest {
                // Given
                val request =
                        CreateTenantRequest(
        ...
        @Test
        fun `should handle tenant creation failure via endpoint`() = runTest {
                // Given
                val request =
                        CreateTenantRequest(
                                name = "Duplicate Name",
        ...
        @Test
        fun `should get tenant details successfully via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should return null when tenant not found via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should update tenant successfully via endpoint`() = runTest {
                // Given
                        ...
                        UpdateTenantRequest(
                                ...
                                settings =
                                        TenantSettingsDto(
                                                ...
                                                features = setOf("advanced-features"),
                                        ),
                        )
        ...
        @Test
        fun `should return null when updating non-existent tenant via endpoint`() = runTest {
                // Given
                val tenantId = "non-existent"
                val updateRequest =
                        UpdateTenantRequest(
        ...
        @Test
        fun `should suspend tenant successfully via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should return false when suspending tenant fails via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should reactivate tenant successfully via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should archive tenant successfully via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should return null when archiving tenant fails via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should list tenants with filtering via endpoint`() = runTest {
                // Given
                val filter =
                        TenantFilter(
                                status = TenantStatus.ACTIVE,
        ...
        @Test
        fun `should check tenant operational status via endpoint`() = runTest {
                // Given
        ...
        @Test
        fun `should handle service exceptions gracefully in endpoint`() = runTest {
                // Given
