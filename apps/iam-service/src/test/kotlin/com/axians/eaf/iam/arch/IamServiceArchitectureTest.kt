...
class IamServiceArchitectureTest {
    ...
    fun `IAM domain should not depend on application layer`() {
        val rule = noClasses()
            .that().resideInAPackage("com.axians.eaf.iam.domain..")
            .should().dependOnClassesThat().resideInAPackage("com.axians.eaf.iam.application..")
    ...
    fun `IAM domain should not depend on infrastructure layer`() {
        val rule = noClasses()
            .that().resideInAPackage("com.axians.eaf.iam.domain..")
            .should().dependOnClassesThat().resideInAPackage("com.axians.eaf.iam.infrastructure..")
    ...
    fun `IAM controllers should be in web layer`() {
        val rule = classes()
            ...
            .should().resideInAPackage("com.axians.eaf.iam.web..")
    ...
    fun `IAM repositories should be in infrastructure layer`() {
        val rule = classes()
            ...
            .should().resideInAPackage("com.axians.eaf.iam.infrastructure..")
    ...
    fun `IAM services should be in application layer`() {
        val rule = classes()
            ...
            .should().resideInAPackage("com.axians.eaf.iam.application..")
