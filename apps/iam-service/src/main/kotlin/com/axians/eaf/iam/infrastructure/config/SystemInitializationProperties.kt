...
data class SystemInitializationProperties(
    /**
     * Whether to initialize the system with a default tenant and superadmin user on startup.
     * This is useful for single-tenant deployments or initial system setup.
     */
