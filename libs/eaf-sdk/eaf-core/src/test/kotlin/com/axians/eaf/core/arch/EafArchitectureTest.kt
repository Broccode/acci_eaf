...
class EafArchitectureTest {
    ...
    fun `commands should be in appropriate packages when they exist`() {
        val rule = classes()
            ...
            .and().haveSimpleNameNotContaining("Test")
            .should().resideInAnyPackage("..domain.command..", "..application.port.in..")
    ...
    fun `test classes should have proper naming convention`() {
        val rule = classes()
            .that().haveSimpleNameContaining("Architecture")
            .or().haveSimpleNameContaining("Integration")
            .or().haveSimpleNameEndingWith("IT")
            .or().haveSimpleNameEndingWith("IntegrationTest")
            .should().resideInAnyPackage("..test..", "..arch..", "..integration..")
    ...
    fun `no cycles should exist in EAF packages`() {
        val rule = com.tngtech.archunit.library.dependencies.SlicesRuleDefinition
            .slices()
    ...
    fun `utility classes should be final and have private constructor`() {
        val rule = classes()
            ...
            .orShould().bePrivate()
            .orShould().haveOnlyPrivateConstructors()
