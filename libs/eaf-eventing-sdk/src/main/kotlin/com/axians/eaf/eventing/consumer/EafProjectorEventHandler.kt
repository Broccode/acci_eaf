 ...
 *
 * This annotation provides a high-level abstraction for building idempotent projectors
 * that consume domain events from NATS JetStream and update read models. It automatically
 * handles:
 ...
 *
 * The underlying implementation uses @NatsJetStreamListener and builds on top of the
 * existing EAF eventing infrastructure.
 */
...
annotation class EafProjectorEventHandler(
     ...
     *
     * This name is used in the processed_events table to track which events
     * this specific projector has already processed. It must be unique across
     * all projectors in the system.
     *
     ...
     *
     * For projectors, DeliverAll is typically the correct choice to ensure
     * all events are processed and read models are built completely.
     */
