 ...
 * using the prefix 'eaf.eventing.nats'.
 */
...
data class NatsEventingProperties(
    ...
    /**
     * Connection name for identification in NATS server logs.
     * Default: "eaf-eventing-sdk"
     */
    val connectionName: String = "eaf-eventing-sdk",
    /**
     * Maximum number of reconnection attempts.
     * -1 means unlimited reconnection attempts.
     * Default: -1
     */
    val maxReconnects: Int = -1,
    /**
     * Wait time between reconnection attempts in milliseconds.
